      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20 shadow-2xl">
          ...
          <button
            ...
            disabled={submitting}
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3 rounded-xl hover:bg-white/90 transition-all mb-4 shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
          >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-dourado-500 hover:bg-dourado-400 text-gray-900 font-bold py-3 rounded-xl transition-all shadow-glow-dourado disabled:opacity-60 disabled:cursor-not-allowed text-sm"
            >
